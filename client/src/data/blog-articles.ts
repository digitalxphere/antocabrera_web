...
export const blogArticles: BlogArticle[] = [
  {
    id: "1",
    title: "Adolescentes y padres: un distanciamiento necesario para crecer",
    slug: "adolescentes-padres-distanciamiento-necesario-crecer",
    excerpt: "Muchos padres viven con dolor y desconcierto el momento en que sus hijos comienzan a alejarse de ellos en la adolescencia. Descubre por qué este proceso es natural y necesario.",
    content: `Muchos padres viven con dolor y desconcierto el momento en que sus hijos comienzan a alejarse de ellos en la adolescencia. Ese niño que antes buscaba refugio en los brazos de mamá o papá ahora prefiere encerrarse en su pieza, conversar con amigos o apoyarse en referentes externos. Este cambio puede sentirse como un rechazo, pero en realidad es parte de un proceso natural y necesario para el desarrollo.
...
En definitiva, la adolescencia no es un tiempo de pérdida, sino de transformación. Para los hijos, significa ensayar la autonomía. Para los padres, implica aprender a querer desde un lugar distinto: menos controlador y más confiado. Y en ese movimiento, ambos crecen.`,
  ...
  {
    id: "2",
    title: "Adolescencia: un viaje de transformación y acompañamiento",
    slug: "adolescencia-viaje-transformacion-acompanamiento",
    excerpt: "La adolescencia es una etapa vital de cambios profundos, donde cada joven se enfrenta a la construcción de su identidad, a la gestión de nuevas emociones y a la búsqueda de pertenencia.",
    content: `La adolescencia es una etapa vital de cambios profundos, donde cada joven se enfrenta a la construcción de su identidad, a la gestión de nuevas emociones y a la búsqueda de pertenencia. No se trata solo de un período de transición, sino de un camino que requiere comprensión, paciencia y acompañamiento sensible por parte de la familia y los profesionales de la salud mental.
